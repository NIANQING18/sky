...
public class OrderServiceImpl implements OrderService {
    ...
    public void paySuccess(String outTradeNo) {
        ...
        map.put("contnet","订单号" + outTradeNo);
    ...
    public OrderStatisticsVO statistics() {
        ...
        Integer toBeConfirmed = orderMapper.getCountByStstus(Orders.TO_BE_CONFIRMED);
        Integer confirmed = orderMapper.getCountByStstus(Orders.CONFIRMED);
        Integer deliveryInProgress = orderMapper.getCountByStstus(Orders.DELIVERY_IN_PROGRESS);
    ...
    public void reminder(Long id) {
        ...
        map.put("type",2);
        map.put("orderId",id);
        map.put("content","订单号为"+orders.getNumber()+"的用户催单了");
